...
class DeleteAsteroid (context: Context, params: WorkerParameters)
    : CoroutineWorker(context , params) {

    private val repository = AsteroidRepository(AsteroidDatabase.getDatabase(context).asteroidDao)
